...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The new person added was being inserted at index 0 instead of added to the back. 
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: There was no condition if turns were <= 0. I added a condition
